...
**Scene 4 dialogue — final set to use:** Cindy `85e1f0e8...` (attempt 11, direct TTS, **confirmed**), Debbie `abec782c-5307-4463-b043-fcafcb2ef31c` (attempt 7, `voice_change` from recording), Steve `95118cc7-0829-4d62-acfc-6a8dad639bc7` (attempt 7, `voice_change` from recording), Michael `429fe422-50bd-49e8-949c-b0118b0edb8e` (attempt 6, `voice_change` from recording, not yet re-checked for pitch — Michael-to-Michael conversion so likely fine).
