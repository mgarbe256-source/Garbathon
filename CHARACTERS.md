...
| **Cindy-2** | `d0bd9737-57ea-437f-8e48-a519a79f5ffc` | **training** (started 2026-08-11) | Fresh retrain from 10 new real reference photos, replacing the old Cindy soul above after repeated identity/rendering failures. **Use this one for all future Cindy generations once ready.** |
